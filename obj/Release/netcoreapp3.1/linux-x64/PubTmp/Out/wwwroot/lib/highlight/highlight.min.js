...
;hljs.registerLanguage("ini",e)})();/*! `c` grammar compiled for Highlight.js 11.5.0 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `pgsql` grammar compiled for Highlight.js 11.5.0 */
(()=>{var E=(()=>{"use strict";return E=>{
...
})();hljs.registerLanguage("pgsql",E)})();/*! `lua` grammar compiled for Highlight.js 11.5.0 */
